...
(function () {
  const row1Logos = [
    ...
    { src: 'images/logos/mikes place white.png',                alt: "Mike's Place" },
    ...
    { src: 'images/logos/marriots.jpeg',             alt: 'marriot'},
    { src: 'images/logos/bullfrog.jpeg',          alt: 'bullfrog' },
    { src: 'images/logos/inspired salon.jpeg',          alt: 'inspired salon' },
    { src: 'images/logos/NOAA Logo.png',          alt: 'NOAA Logo' },
    { src: 'images/logos/Feli-Logo-Black.png',          alt: 'Feli-Logo-Black' },
    { src: 'images/logos/Next Level Gym - Logo (1).png',          alt: 'Next Level Gym - Logo (1)' },
    { src: 'images/logos/Backstage-Xchange-Logo.png',          alt: 'Backstage-Xchange-Logo' },
    { src: 'images/logos/Anoshka - Logo .png',          alt: 'Anoshka - Logo ' },
    { src: 'images/logos/jamming goat.jpeg',          alt: 'Jamming goat (1)' },
    { src: 'images/logos/borecha.png',          alt: 'borecha' },
    { src: 'images/logos/Soul Souffle.png',          alt: 'Soul Souffle' },
    { src: 'images/logos/QuickSandEvents.png',          alt: 'Quicksand events' },
    { src: 'images/logos/Thalassa.webp',          alt: 'Thalassa' },
    { src: 'images/logos/The house of Hyderabad biryani.png',          alt: 'The house of Hyderabad biryani' },
    { src: 'images/logos/tinera stays.png',          alt: 'tinera stays' },
    { src: 'images/logos/world of wine.png',          alt: 'world of wine' },

  ];
  const row2Logos = [
    { src: 'images/logos/Club-Rickys-Logo.png',     alt: "Ricky's" },
    { src: 'images/logos/reginaldo(whitte).png',            alt: 'Reginaldo Connect' },
    ...
    { src: 'images/logos/Yacht  club goa.png',             alt: 'Yacht club goa' },
    { src: 'images/logos/hive.jpeg',             alt: 'hive' },
    { src: 'images/logos/Krank.png',             alt: 'Krank' },
    { src: 'images/logos/myra.jpeg',             alt: 'myra' },
    { src: 'images/logos/purple mint.jpeg',             alt: 'Purple Mint kitchen & Bar' },
    { src: 'images/logos/MILLIONHAIR.jpg',             alt: 'MILLIONHAIR' },
    { src: 'images/logos/white.png',             alt: 'white' },
    { src: 'images/logos/sunschool.png',             alt: 'sunschool' },
     { src: 'images/logos/parashoot.png',             alt: 'parashoot' },
     { src: 'images/logos/RADISSON.jpg',             alt: 'RADISSON' },
     { src: 'images/logos/SOCHI.jpg',             alt: 'SOCHI' },
   { src: 'images/logos/MAYFAIR.jpg',             alt: 'MAYFAIR' },
   { src: 'images/logos/MIDDLE.jpg',             alt: 'MIDDLE' },
   { src: 'images/logos/KAMAT.jpg',             alt: 'KAMAT' },
   { src: 'images/logos/BAY.jpg',             alt: 'BAY' },
   { src: 'images/logos/HOMEFIRST.png',             alt: 'HOMEFIRST' },
   { src: 'images/logos/FlyingFriday.png',             alt: 'FLYING' },
   { src: 'images/logos/Fred Dsouza.png',             alt: 'FRED' },
   { src: 'images/logos/CLOVER.png',             alt: 'CLOVER' },
   { src: 'images/logos/theme props.jpg',             alt: 'theme props' },
   { src: 'images/logos/mambo.jpg',             alt: 'mambo' },
   { src: 'images/logos/CapeTownCafe.png',             alt: 'CapeTownCafe' },
   { src: 'images/logos/Mickeys.png',             alt: 'Mickeys' },
   { src: 'images/logos/Double Hangover Easter Bash - Logo.png',             alt: 'Double Hangover Easter Bash - Logo' },
   { src: 'images/logos/Ziki Logo (Black).png',             alt: 'Ziki Logo (Black)' },
   { src: 'images/logos/bash bishtro.jpeg',             alt: 'bash bishtro' },
