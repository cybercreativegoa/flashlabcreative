...
(function () {
  const row1Logos = [
    ...
    { src: 'images/logos/bullfrog.jpg',          alt: 'bullfrog' },
    ...
    { src: 'images/logos/Jamming goat.png',          alt: 'Jamming goat (1)' },
  ...
  const row2Logos = [
    ...
    { src: 'images/logos/hive.png',             alt: 'hive' },
    { src: 'images/logos/Krank.png',             alt: 'Krank' },
    { src: 'images/logos/myra.png',             alt: 'myra' },
    { src: 'images/logos/Purple Mint kitchen & Bar.png',             alt: 'Purple Mint kitchen & Bar' },
