...
(function () {
  ...
  const CLIENTS_BY_YEAR = {
      '2016': [
        ...
        { name: 'Strobe Nightlife', logo: 'images/logos/strobe.jpeg', desc: 'High-energy nightlife brand bringing Goa\'s best DJs to the floor.' },
      ],
      '2017': [
      ...
      '2018': [
        ...
        { name: 'Jamming Goat', logo: 'images/logos/jamming goat.jpeg', desc: 'A music-first cafe where live sessions meet good coffee.' },
      ...
      '2019': [
        ...
        { name: 'The Hangover', logo: 'images/logos/The Hangover.jpeg', desc: 'Reel-first content driving buzz for Goa\'s nightlife hotspot.' },
      ...
      '2020': [
        ...
        { name: 'Adinco Distilleries', logo: 'images/logos/adineo distillerirs.png', desc: 'A craft distillery bottling spirits with a distinctly Goan character.' },
        { name: 'Forca Foundation', logo: 'images/logos/forca goa.jpeg', desc: 'A community foundation driving sport and social impact in Goa.' },
        ...
        { name: 'The Hive', logo: 'images/logos/hive.jpeg', desc: 'A buzzing co-working and community space for Goa\'s creators.' },
        ...
        { name: 'Myra Goa', logo: 'images/logos/myra.jpeg', desc: 'A boutique hospitality brand offering curated Goan stays.' },
      ],
      '2021': [
      ...
      '2024': [
        ...
        { name: 'Purple Mint', logo: 'images/logos/purple mint.jpeg', desc: 'A boutique salon and styling studio for the modern Goan.' },
        { name: 'Papillion Salon', logo: 'images/logos/Papiillon-Logo.png', desc: 'A premium salon offering styling and beauty treatments.' },
      ],
      '2025': [
        { name: 'Coco Leni', logo: 'images/logos/cocoleni.jpeg', desc: 'A boutique lifestyle brand with a breezy, coastal aesthetic.' },
        ...
        { name: 'Piccola Roma', logo: 'images/logos/piccola roma.jpeg', desc: 'An intimate Italian trattoria serving authentic Roman classics.' },
        { name: 'Bash Bistro', logo: 'images/logos/bash bishtro.jpeg', desc: 'A vibrant bistro serving globally-inspired plates and cocktails.' },
        ...
        { name: 'Aadhvay', logo: 'images/logos/aadhvay.jpeg', desc: 'A wellness and lifestyle brand rooted in holistic living.' },
      ],
      '2026': [
